    ...
    <div id="menu" class="section lb">
        ...
        <div class="col-md-3">
            ...
            <a class="hvr-radial-in" href="#">$ 18.00</a>
                ...
                <div class="col-md-3">
                    <div class="services-inner-box">
            <div class="ser-icon">
              <img src="<?= base_url('template/uploads/menu-img-02.jpg')?>" class="img-fluid" alt="" />
            </div>
            <h2>Vegetable Name..</h2>
        ...
        <div class="col-md-3">
                    <div class="services-inner-box">
            <div class="ser-icon">
              <img src="<?= base_url('template/uploads/menu-img-03.jpg')?>" class="img-fluid" alt="" />
            </div>
            <h2>Vegetable Name..</h2>
        ...
        <div class="col-md-3">
                    <div class="services-inner-box">
            <div class="ser-icon">
              <img src="<?= base_url('template/uploads/menu-img-04.jpg')?>" class="img-fluid" alt="" />
            </div>
            <h2>Vegetable Name..</h2>
        ...
        <div class="col-md-3">
                    <div class="services-inner-box">
            <div class="ser-icon">
              <img src="<?= base_url('template/uploads/menu-img-05.jpg')?>" class="img-fluid" alt="" />
            </div>
            <h2>Vegetable Name..</h2>
        ...
        <div class="col-md-3">
                    <div class="services-inner-box">
            <div class="ser-icon">
              <img src="<?= base_url('template/uploads/menu-img-06.jpg')?>" class="img-fluid" alt="" />
            </div>
            <h2>Vegetable Name..</h2>
        ...
        <div class="col-md-3">
                    <div class="services-inner-box">
            <div class="ser-icon">
              <img src="<?= base_url('template/uploads/menu-img-07.jpg')?>" class="img-fluid" alt="" />
            </div>
            <h2>Vegetable Name..</h2>
        ...
        <div class="col-md-3">
                    <div class="services-inner-box">
            <div class="ser-icon">
              <img src="<?= base_url('template/uploads/menu-img-08.jpg')?>" class="img-fluid" alt="" />
            </div>
            <h2>Vegetable Name..</h2>
